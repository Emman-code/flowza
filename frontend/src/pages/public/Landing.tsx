      ...
      <section className="relative pt-24 sm:pt-28 md:pt-32 pb-14 md:pb-20 px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto z-10">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 lg:gap-10 items-center">
          ...
          <div className="lg:col-span-5 space-y-6">
            {/* Primary Headline with Handcrafted SVG Curved Underline */}
            <h1 className="font-heading text-4xl sm:text-5xl lg:text-[54px] font-black tracking-[-0.04em] text-neutral-950 dark:text-white leading-[1.04]">
              One wholesale order.{' '}
              <span className="relative inline-block whitespace-nowrap">
                <span className="relative z-10">Both sides in sync.</span>
                {/* Handcrafted curved vector underline */}
                <svg
                  className="absolute -bottom-2 left-0 w-full h-3.5 text-amber-500 overflow-visible pointer-events-none"
                  viewBox="0 0 260 14"
                  fill="none"
